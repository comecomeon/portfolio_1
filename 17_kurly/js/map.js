...
function initialize() {
			...
			*/
			//학원 건물 - @37.5972424,127.0855957
			var Y_point			= 37.5705067;		// Y 좌표
			var X_point			= 127.0855957;		// X 좌표

			var zoomLevel		= 15;						// 첫 로딩시 보일 지도의 확대 레벨

			var markerTitle		= "이젠컴퓨터학원";				// 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
			...
			var contentString	= '<div id="content">' +
					...
					'<div id="bodyContent">'+ 
						'<p>이젠 컴퓨터학원입니다!. <br /><a href="http:/www.ezen.co.kr" target="_blank">http:/www.ezen.co.kr</a></p>'+	
					'</div>'+ 
				'</div>';
